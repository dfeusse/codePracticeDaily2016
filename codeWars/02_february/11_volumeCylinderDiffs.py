...
Could you calculate the remaining volume? Your function tankvol(h, d, vt) returns an 
...
tankvol(80,120,3500) should return 2478 (calculation gives about: 247
'''
import math
# V = pi * r ^^ 2 * h

def tankvol(h, d, vt):
	radius = math.sqrt(vt/(math.pi*h))
	print '-------'
	print vt
	print math.pi * (math.pow(radius,2)) * h
